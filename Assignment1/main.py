...
def main():
    ...
    for o, a in optlist:
        if o in ("-help"):
            ...
            print(
                "Solve set of test instances and generate plots: main.py --testinstances --plots"
            )
            exit()
        elif o in ("--plots"):
            plots = True
    ...
    if plots:
        ...
        plotter.plot_results(
            runtime_astar,
            runtime_dijkstra,
            "Running Time in Seconds (A*)",
            "Running Time in Seconds (Dijkstra)",
            "running_time",
        )
        plotter.plot_results(
            nodes_expanded_astar,
