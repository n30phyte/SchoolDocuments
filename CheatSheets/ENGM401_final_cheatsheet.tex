...
\begin{multicols}{3}
    ...
    \begin{align*}
        % \textbf{Operating}                                                \\
        % \text{O} & = \text{Net Income} + \text{Depreciation}              \\
        % \textbf{Investing}                                                \\
        % \text{I} & = -\text{Capital Investment} + \text{Asset Sales}      \\
        %          & - \text{Gains Tax} - \text{Working Capital Investment} \\
        %          & + \text{Working Capital Recovery}                      \\
        % \textbf{Financing}                                                \\
        % \text{F} & = \text{Borrowed Funds} - \text{Principal Repayment}   \\
